...
public class CloudinaryService {
    ...
    public Map<String, Object> uploadReceipt(MultipartFile file, Long userId) throws IOException {
        ...
        // Upload to specific folder: ledgera/receipts/user_{userId}/
        String folder = "ledgera/receipts/user_" + userId;
        ...
        Map<String, Object> uploadParams = ObjectUtils.asMap(
                ...
                "tags", new String[]{"receipt", "ledgera", "user_" + userId}
        );
    ...
    public String getUserReceiptFolder(Long userId) {
        return "ledgera/receipts/user_" + userId;
    }
