...
public class EmailService {
    ...
    public void sendWorkspaceInvitation(String toEmail, String inviterName, String workspaceName, String invitationToken) {
        ...
        try {
            CreateEmailOptions params = CreateEmailOptions.builder()
                    .from(fromAddress)
                    .to(toEmail)
                    .subject("You've been invited to join " + workspaceName + " on Revive")
                    .html(htmlContent)
                    .build();
    ...
    private String buildPasswordResetEmailHtml(String userName, String resetLink, String resetToken) {
        ...
        String html = "<!DOCTYPE html>" +
                ...
                "<img src=\"https://revive-ops.vercel.app/icon.png\" alt=\"Revive Logo\" width=\"72\" height=\"72\" style=\"display:block;margin:0 auto 18px auto;\">" +

                "<h1 style=\"margin:0;font-size:28px;font-weight:700;color:#111111;letter-spacing:-0.5px;\">Revive</h1>" +
    ...
    private String buildWorkspaceInvitationEmailHtml(String inviterName, String workspaceName, String invitationLink) {
        ...
        String html = "<!DOCTYPE html>" +
                ...
                "<p style=\"margin:0 0 36px 0;font-size:15px;color:#666666;line-height:1.8;\">" +
                inviterName + " has invited you to join <strong style=\"color:#111111;\">" + workspaceName + "</strong> on Revive." +
                "</p>" +
